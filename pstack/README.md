...
[`/poteto-mode`](./skills/poteto-mode/SKILL.md) works extremely well with the `/loop` skill. you can make Claude Code work for many hours without sacrificing rigor.
